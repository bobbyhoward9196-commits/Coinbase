...
const iconMap = {
  Laptop, Smartphone, Mail, Wifi, HardDrive, MonitorSmartphone,
  Building2, MapPin, Download, ShieldCheck,
};
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:18005550100" className="font-display text-2xl font-bold text-white">1-800-555-0100</a>
                    </div>
                  </div>
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 space-y-4 text-sm">
              <div className="flex items-start gap-3"><Phone className="h-5 w-5 text-[#0B3B82] mt-0.5" /> <div><div className="font-semibold">1-800-555-0100</div><div className="text-slate-500">Mon–Fri 8am–8pm ET · Weekends on call</div></div></div>
